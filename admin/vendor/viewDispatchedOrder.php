    ...
    <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
        ...
        <div class="content">
            ...
            <div class="intro-y flex items-center mt-8">
                <h2 class="text-lg font-medium mr-auto">Dispatched Orders</h2>
            </div>
                ...
                <div class="intro-y col-span-12 lg:col-span-12">
                    <div class="intro-y box">
                        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60">
                            <h2 class="font-medium text-base mr-auto">Dispatched Order List</h2>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            if (!$vendor_id) {
                                                ...
                                                $query = "SELECT o.order_id, o.order_number, o.customer_name, o.customer_phone, 
                                                         ...
                                                         WHERE o.order_status = 'Dispatched' AND p.vendor_id = ?
                                                ...
                                                if ($stmt) {
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td colspan="10" class="text-center">No dispatched orders found</td>
                                                        </tr>
                                                        <?php
                                                    }
    ...
    <script>
        function completeOrder(orderId) {
            if (confirm('Are you sure you want to mark this order as completed?')) {
                window.location.href = 'updateOrderStatus.php?order_id=' + orderId + '&status=Completed';
            }
        }
    </script>
</body>
