...
// Fetch online payment orders (not COD/Cash)
$sql = "SELECT o.order_id, o.order_number, u.user_name, u.phone, o.total_amount, o.order_status, o.payment_status, o.payment_method, o.created_at
        ...
        WHERE (o.payment_method IS NOT NULL AND LOWER(o.payment_method) NOT IN ('cod','cash'))
           OR (o.payment_method IS NULL OR o.payment_method = '')
...
<head>
    ...
    <title>Online Payments - Admin</title>
...
<div class="container-fluid p-4">
    <div class="d-flex align-items-center justify-content-between payment-header">
        <h1 class="h4 mb-0">Online Payments</h1>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="8" class="text-center py-4">No online payment orders found.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
