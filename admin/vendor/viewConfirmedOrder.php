    ...
    <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
        ...
        <div class="content">
            ...
            <div class="intro-y flex items-center mt-8">
                <h2 class="text-lg font-medium mr-auto">Confirmed Orders</h2>
            </div>
                ...
                <div class="intro-y col-span-12 lg:col-span-12">
                    <div class="intro-y box">
                        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60">
                            <h2 class="font-medium text-base mr-auto">Confirmed Order List</h2>
                        </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            if (!$vendor_id) {
                                                ...
                                                // join against order_items to work with multi‑item orders
                                                $query = "SELECT o.order_id, o.order_number, o.customer_name, o.customer_phone, 
                                                         ...
                                                         WHERE o.order_status = 'Confirmed' AND o.vendor_id = ?
                                                         GROUP BY o.order_id
                                                ...
                                                if ($stmt) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-primary btn-sm" onclick="dispatchOrder(<?php echo $row['order_id']; ?>)">Dispatch</button>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                        }
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td colspan="10" class="text-center">No confirmed orders found</td>
                                                        </tr>
                                                        <?php
                                                    }
    ...
    <script>
        function dispatchOrder(orderId) {
            if (confirm('Are you sure you want to dispatch this order?')) {
                window.location.href = 'updateOrderStatus.php?order_id=' + orderId + '&status=Dispatched';
            }
        }
    </script>
</body>
