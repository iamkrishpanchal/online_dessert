...
if ($is_admin) {
    // Main admin sees all orders from today only
    $sql_stats = "SELECT order_status, COUNT(*) as count FROM tbl_orders WHERE DATE(created_at) = CURDATE() GROUP BY order_status";
} else {
...
if ($is_admin) {
    ...
    $pres = mysqli_query($conn, "SELECT product_id,product_name FROM tbl_products ORDER BY product_name");
                                        ...
                                        <tbody>
                                            ...
                                            if ($is_admin) {
                                                $sql = "SELECT o.order_id, o.order_number, u.user_name, u.phone, 
                                                               o.total_amount, o.order_status, o.payment_status, o.delivery_status, o.rider_id, o.created_at,
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlspecialchars(!empty($row['rider_name']) ? $row['rider_name'] : ($row['rider_id'] ? 'ID '.$row['rider_id'] : '')); ?></td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="action-buttons">
                                                                    ...
                                                                    // Allow vendors to confirm orders and assign riders (via order details)
                                                                    if ($current_status === 'Pending') {
                                                                        ?>
                                                                        <a href="admin_update_order_status.php?order_id=<?php echo $row['order_id']; ?>&status=Confirmed" 
                                                                           class="btn btn-sm btn-info" title="Confirm Order">Confirm</a>
                                                                        <?php
                                                                    }
                                                                    ...
                                                                    if ($current_status === 'Confirmed') {
                                                                        ...
                                                                        <a href="order_details.php?order_id=<?php echo $row['order_id']; ?>" 
                                                                           class="btn btn-sm btn-primary" title="Assign Rider">Assign Rider</a>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <a href="order_details.php?order_id=<?php echo $row['order_id']; ?>" 
                                                                   class="btn btn-sm btn-secondary" title="View Details">Details</a>
                                                            </td>
                                                            <?php endif; ?>
                                                        </tr>
                                                        <?php
